...
namespace part4.Data
{
    public class DbInitializer
    {
        public static void Initialize(OrderContext context)
        {
            ...
            var upgradePJTs = new UpgradePJT[]
            {
                new UpgradePJT{OrderID=1,UpgradeID=1},
                new UpgradePJT{OrderID=1,UpgradeID=4},
                new UpgradePJT{OrderID=1,UpgradeID=6},
                new UpgradePJT{OrderID=1,UpgradeID=10},
                new UpgradePJT{OrderID=1,UpgradeID=11},
                new UpgradePJT{OrderID=1,UpgradeID=12},

                new UpgradePJT{OrderID=2,UpgradeID=15},
                new UpgradePJT{OrderID=2,UpgradeID=20},
                new UpgradePJT{OrderID=2,UpgradeID=23},
                new UpgradePJT{OrderID=2,UpgradeID=27},
                new UpgradePJT{OrderID=2,UpgradeID=30},
                new UpgradePJT{OrderID=2,UpgradeID=32}

            };

            context.UpgradePJTs.AddRange(upgradePJTs);
            context.SaveChanges();
